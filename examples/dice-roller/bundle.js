...
function rollDice(store) {
  var diceCount = store.getState().diceCount;
...
ui.addDieBtn.addEventListener("click", function (ev) {
  ev.preventDefault();
  store.dispatch(changes.addDie, d6());
});

ui.removeDieBtn.addEventListener("click", function (ev) {
  ev.preventDefault();
  store.dispatch(changes.removeDie);
});

ui.rollBtn.addEventListener("click", function (ev) {
  ev.preventDefault();
  rollDice(store);
});
